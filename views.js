            ...
            <div className="mb-3">
              <div className="bg-gradient-to-r from-rose-50 to-orange-50 border-2 border-rose-400 rounded-lg p-2">
                ...
                {isAdmin && window.BKK.selectedCity && (() => {
                  ...
                  // All interests: interestOptions already filtered by cityHiddenInterests for users
                  // Admin sees full BKK list
                  // Admin sees ALL interests (BKK + custom), user sees filtered by city
